...
| UI & frontend | `bitrix-components`, `bitrix-extensions`, `bitrix-chef`, `bitrix-ui`, `bitrix-vue`, `bitrix-cms-basics`, `bitrix-landing`, `bitrix-seo` | Components, JS extensions (AMD), extension build tooling (@bitrix/chef), Vue, admin UI, pages/menus/templates, landing pages, SEO maps |
