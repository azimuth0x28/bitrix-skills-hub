...
41 скилл по темам ядра D7 и смежным областям. Каждый — самодостаточный справочник, который агент применяет сразу.
...
Скиллы про сами скиллы: конвенции авторства и контроль качества.
...
Новый скилл создавайте через `bitrix-skill-creator`: он знает конвенции репозитория — структуру, frontmatter, обязательные слои, чеклисты. Готовый черновик прогоните через `bitrix-skill-eval`: слепой тест и рубрика Q1–Q10 отсеивают слабые скиллы до попадания в каталог.
